...
import "./login.css";
  ...
  const commonDomains = ["@gmail.com", "@wellspring.edu.vn"];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Vai trò người dùng sau khi đăng nhập:", user.role);
      ...
      if (user.role === "admin") {
        ...
        console.error("Vai trò không hợp lệ:", user.role);
      }
      console.log("Điều hướng đến:", user.role === "admin" ? "/admin" : "/dashboard");
